...
const question =
  // "다음의 음식점 리뷰를 보고 너가 별점을 준다고 생각하고 1점부터 5점까지 중에 'n점' 이라는 형식으로만 말해줘 자 이제 리뷰 말해줄게";
  "다음의 음식점 리뷰를 보고 너가 별점을 준다고 생각하고 1점부터 5점까지 중에 'n점' '이유는 이래서입니다' 이라는 형식으로만 말해줘 자 이제 리뷰 말해줄게";
